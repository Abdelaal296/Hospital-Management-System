        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReportImagePath = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RoomAvailabilities_AspNetUsers_PatientID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Appointments_RoomAvailabilities_RoomAvailabilityID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Bills_RoomAvailabilities_RoomAvailabilityID",
                        column: x => x.RoomAvailabilityID,
                        principalTable: "RoomAvailabilities",
                        principalColumn: "ID");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2d373bb2-dda4-44df-a2f3-c818fb18f5e7", "35902d35-c116-4a7b-b636-f316264c31c5", "Patient", "patient" },
                    { "866f6b36-0976-43b6-a7f3-1e882aa1908c", "a92a7f9f-a3c1-4c29-be42-d4af530d28d3", "Admin", "admin" },
                    { "bef983c1-26e3-4e3a-9696-7efee840b899", "a16b8ee1-d4fb-4ffd-b82e-ffa39f04fb98", "Doctor", "doctor" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_RoomAvailabilityID",
                table: "Appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bills_RoomAvailabilityID",
                table: "Bills",
                column: "RoomAvailabilityID");

            migrationBuilder.CreateIndex(
                name: "IX_RoomAvailabilities_PatientID",
